package com.ohgiraffers.secton01.headers;
...
public class RequestHeaderPrintServlet extends HttpServlet {
        ...
        * 헤더의 종류 4가지
        * 1. General header
        *       요청 및 응답 모두에 적용되지만 최종적으로 body에 전송되는 것과 관련이 없는 헤더
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // host : 서버의 도메인 네임과 서버가 현재 Listening 중인 TCP 포트 지정 ( 반드시 하나가 존재하고 두개면 404 ERROR)
        ...
        // upgrade-insecure-request : 클라이언트가 서버한테 http -> https로 업그레이드를 요청할 때
