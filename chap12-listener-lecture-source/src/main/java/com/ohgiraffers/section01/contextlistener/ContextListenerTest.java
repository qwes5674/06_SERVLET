...
public class ContextListenerTest implements ServletContextListener, ServletContextAttributeListener {
    ...
    *
    * 1. context( -> 톰캣 컨테이너 자체에 리스너늘 연결 )
    *   1-1. ServletContextListener : 어플리케이션의 시박, 종료에 대한 이벤트리스너
    *   1-2. ServletContextAttributeListener :
    *         -context에 attribute를 추가, 제거, 수정에 대한 이벤트리스너
    *
    * */
    ...
    public void contextInitialized(ServletContextEvent sce) {
        // context가 최초 생성할 때 생성자 호출 이후 동작하는 메소드
    ...
    public void attributeReplaced(ServletContextAttributeEvent event) {
        ...
        System.out.println("context attributeReplace");
    }
}
